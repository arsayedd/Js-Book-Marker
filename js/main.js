...
function visit(bookmark) {
    ...
    div.innerHTML += "<div class=\"webmark row\" id=\"" + bookmark.name + "\"></div> "; 
    ...
    var webmark = document.getElementById(bookmark.name);
    webmark.innerHTML = h4 + link + btndelete;
    drawn.push(bookmark);
}

function deleteWeb(bookmark) {
    drawn.splice(drawn.indexOf(bookmark), 1);
    var div = document.getElementById('bookmarkList');
    var webmark = document.getElementById(bookmark.name); 
    var k = "<div class=\"webmark row\" id=\"" + bookmark.name + "\">" + webmark.innerHTML + "</div>";
